...
export const register = async (req: Request<{}, {}, RegisterBody>, res: Response): Promise<void | Response> => {
	try {
...
export const login = async (req: Request<{}, {}, LoginBody>, res: Response): Promise<void | Response> => {
	try {
...
export const forgotPassword = async (req: Request<{}, {}, ForgotPasswordBody>, res: Response): Promise<void | Response> => {
	try {
...
export const resetPassword = async (req: Request<{}, {}, ResetPasswordBody>, res: Response): Promise<void | Response> => {
	try {
